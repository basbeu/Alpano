...
public class ExceptionTest {
    ...
    public void testComposite1() throws Exception {
        new CompositeDiscreteElevationModel(null,new WavyDEM(new Interval2D(new Interval1D(0, 6),new Interval1D(0,6))));
    ...
    public void testComposite2() throws Exception {
        new CompositeDiscreteElevationModel(new WavyDEM(new Interval2D(new Interval1D(0, 6),new Interval1D(0,6))),null);
