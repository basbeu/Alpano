...
public final class Interval2D {
     ...
     * @param x entier representant le premier nombre du couple 
     * @param y entier representant le deuxieme nombre du couple
     * @return un booleen indiquant si le couple est compris dans l'intervalle
     */
    ...
    /**
     * @return un entier indiquant la taille de l'intervalle
     */
    public int size(){
